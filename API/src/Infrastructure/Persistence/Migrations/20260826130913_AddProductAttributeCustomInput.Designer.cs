...
namespace VSky.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260826130913_AddProductAttributeCustomInput")]
    partial class AddProductAttributeCustomInput
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VSky.Domain.Entities.AuthorizeNetCredential", b =>
                {
                    ...
                    b.Property<string>("PublicClientKey")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("VSky.Domain.Entities.CMSBanner", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DisplayLocation", "DisplayOrder");

                    b.ToTable("CMSBanners", (string)null);
                });

            modelBuilder.Entity("VSky.Domain.Entities.CMSBlogPost", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("FeaturedImageMediaId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FeaturedImageMediaId");

                    b.HasIndex("Slug")
                        .IsUnique()
                        .HasFilter("[Deleted] = 0");

                    b.HasIndex("Status", "PublishedOnUtc");

                    b.ToTable("CMSBlogPosts", (string)null);
                });

            modelBuilder.Entity("VSky.Domain.Entities.CMSCategoryPageConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("YmalCollectionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("YmalCollectionId");

                    b.ToTable("CMSCategoryPageConfigs", (string)null);
                });

            modelBuilder.Entity("VSky.Domain.Entities.CMSCategoryPinnedProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CategoryPageConfigId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CategoryPageConfigId", "DisplayOrder");

                    b.HasIndex("CategoryPageConfigId", "ProductId")
                        .IsUnique();

                    b.ToTable("CMSCategoryPinnedProducts", (string)null);
                });

            modelBuilder.Entity("VSky.Domain.Entities.CMSHomePageSection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CMSHomePageSections", (string)null);
                });

            modelBuilder.Entity("VSky.Domain.Entities.CMSNewsletterSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("UnsubscribedOnUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("CMSNewsletterSubscriptions", (string)null);
                });

            modelBuilder.Entity("VSky.Domain.Entities.CMSPage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PageGroupId", "DisplayOrder");
            ...
            modelBuilder.Entity("VSky.Domain.Entities.CMSPageGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CMSPageGroups", (string)null);
                });

            modelBuilder.Entity("VSky.Domain.Entities.CMSProductCollection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CMSProductCollections", (string)null);
                });

            modelBuilder.Entity("VSky.Domain.Entities.CMSProductCollectionItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CMSProductCollectionItems", (string)null);
                });

            modelBuilder.Entity("VSky.Domain.Entities.CMSSearchPageContent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("NoResultsBannerId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("NoResultsCollectionId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("NoResultsMessage")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ResultsCountLabel")
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)");
                    ...
                    b.HasIndex("NoResultsBannerId");

                    b.HasIndex("NoResultsCollectionId");

                    b.ToTable("CMSSearchPageContent", (string)null);
                });
            ...
            modelBuilder.Entity("VSky.Domain.Entities.CustomerPointsBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CustomerPointsBalances", (string)null);
                });
            ...
            modelBuilder.Entity("VSky.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<decimal>("PaymentFeeTotal")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("VSky.Domain.Entities.PointsTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VSky.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<string>("SubscriptionIntervals")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("VSky.Domain.Entities.ProductQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VSky.Domain.Entities.ProductReview", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VSky.Domain.Entities.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("NextOrderOnUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("Status", "NextOrderOnUtc");
            ...
            modelBuilder.Entity("VSky.Domain.Entities.CMSBanner", b =>
                {
                    b.HasOne("VSky.Domain.Entities.Media", "ImageMedia")
                        .WithMany()
            ...
            modelBuilder.Entity("VSky.Domain.Entities.CMSBlogPost", b =>
                {
                    b.HasOne("VSky.Domain.Entities.Media", "FeaturedImageMedia")
                        .WithMany()
                        .HasForeignKey("FeaturedImageMediaId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("FeaturedImageMedia");
                });

            modelBuilder.Entity("VSky.Domain.Entities.CMSCategoryPageConfig", b =>
                {
                    b.HasOne("VSky.Domain.Entities.Media", "BannerMedia")
                        .WithMany()
                    ...
                    b.HasOne("VSky.Domain.Entities.CMSProductCollection", "YmalCollection")
                        .WithMany()
                        .HasForeignKey("YmalCollectionId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("YmalCollection");
                });

            modelBuilder.Entity("VSky.Domain.Entities.CMSCategoryPinnedProduct", b =>
                {
                    b.HasOne("VSky.Domain.Entities.CMSCategoryPageConfig", "CategoryPageConfig")
                        .WithMany("PinnedProducts")
                        .HasForeignKey("CategoryPageConfigId")
                    ...
                    b.Navigation("CategoryPageConfig");
            ...
            modelBuilder.Entity("VSky.Domain.Entities.CMSPage", b =>
                {
                    b.HasOne("VSky.Domain.Entities.CMSPageGroup", "PageGroup")
                        .WithMany("Pages")
            ...
            modelBuilder.Entity("VSky.Domain.Entities.CMSProductCollectionItem", b =>
                {
                    b.HasOne("VSky.Domain.Entities.CMSProductCollection", "Collection")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("VSky.Domain.Entities.CMSSearchPageContent", b =>
                {
                    b.HasOne("VSky.Domain.Entities.CMSBanner", "NoResultsBanner")
                        .WithMany()
                        .HasForeignKey("NoResultsBannerId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("VSky.Domain.Entities.CMSProductCollection", "NoResultsCollection")
                        .WithMany()
                        .HasForeignKey("NoResultsCollectionId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("NoResultsBanner");

                    b.Navigation("NoResultsCollection");
                });
            ...
            modelBuilder.Entity("VSky.Domain.Entities.ProductReview", b =>
                {
                    b.HasOne("VSky.Domain.Entities.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("VSky.Domain.Entities.Subscription", b =>
                {
                    ...
                    b.HasOne("VSky.Domain.Entities.Address", null)
                        .WithMany()
                        .HasForeignKey("ShippingAddressId")
                        .OnDelete(DeleteBehavior.NoAction);
